...
| `ground-wood-color.jpg` | Poly Haven "Wood Table 001" (colour; API key `Diffuse`) | https://polyhaven.com/a/wood_table_001 — file https://dl.polyhaven.org/file/ph-assets/Textures/jpg/1k/wood_table_001/wood_table_001_diff_1k.jpg | 2026-09-24 | 1K JPG, sRGB colour -> `node scripts/bake-environments.mjs --texture wood_table_001_diff_1k.jpg ground-wood-color.jpg` (q82). Scanned tile 1500 mm (`api.polyhaven.com/info/wood_table_001` dimensions). |
| `ground-wood-normal.jpg` | Poly Haven "Wood Table 001" (OpenGL normal map; API key `nor_gl`) | https://polyhaven.com/a/wood_table_001 — file https://dl.polyhaven.org/file/ph-assets/Textures/jpg/1k/wood_table_001/wood_table_001_nor_gl_1k.jpg | 2026-09-24 | 1K JPG, OpenGL (+Y up) tangent normals, kept as data -> `node scripts/bake-environments.mjs --texture wood_table_001_nor_gl_1k.jpg ground-wood-normal.jpg --data --quality 95` (4:4:4 chroma, no grayscale/tint; q95 because the map is nearly flat and the viewer amplifies it, so q90's 8x8 blocks showed). |
| `ground-wood-rough.jpg` | Poly Haven "Wood Table 001" (roughness; API key `Rough`) | https://polyhaven.com/a/wood_table_001 — file https://dl.polyhaven.org/file/ph-assets/Textures/jpg/1k/wood_table_001/wood_table_001_rough_1k.jpg | 2026-09-24 | 1K JPG, grayscale data -> `node scripts/bake-environments.mjs --texture wood_table_001_rough_1k.jpg ground-wood-rough.jpg --gray` (source is neutral grey; channel means unchanged). |
...
`ground-wood-*`) are Poly Haven textures, CC0 like its HDRIs above
